...
class ImageProcessor {
    ...
    getIconMaskForRectangle(rectangle) {
        ...
        // Return visibility based on alpha threshold
        return {
            visible: alpha > this.iconConfig.alphaThreshold,
            alpha: alpha,
            x: x,
            y: y
        };
    ...
    getIconMaskForRectangleDetailed(rectangle) {
        ...
        for (let sx = 0; sx < samplePoints; sx++) {
            for (let sy = 0; sy < samplePoints; sy++) {
                ...
                if (alpha > this.iconConfig.alphaThreshold) {
                    visibleSamples++;
                }
            }
        }
        ...
        return {
            ...
            visible: maxAlpha > this.iconConfig.alphaThreshold || visibilityRatio > 0.3,
